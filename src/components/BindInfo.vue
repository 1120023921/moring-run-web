        ...
        API.addUserOpenId(this.param)
          .then(res => {
            if (res.data.code === 200) {
              ...
              window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf0d2b18286906056&redirect_uri=http%3a%2f%2fwtjs.doublehh.cn%2fmorning-run%2fwx%2fauth%2fwxf0d2b18286906056%2flogin&response_type=code&scope=snsapi_userinfo&state=login#wechat_redirect';
